...
[![npm version](https://badge.fury.io/js/react-data-export-typescript.svg)](https://badge.fury.io/js/react-data-export-typescript)
[![dependencies Status](https://david-dm.org/securedeveloper/react-data-export-typescript/status.svg)](https://david-dm.org/securedeveloper/react-data-export-typescript)
[![devDependencies Status](https://david-dm.org/securedeveloper/react-data-export-typescript/dev-status.svg)](https://david-dm.org/securedeveloper/react-data-export-typescript?type=dev)
[![Build Status](https://travis-ci.org/securedeveloper/react-data-export-typescript.svg?branch=master)](https://travis-ci.org/securedeveloper/react-data-export-typescript)
[![Vulnerabilities](https://snyk.io/test/github/securedeveloper/react-data-export-typescript/badge.svg)](https://snyk.io/test/github/securedeveloper/react-data-export-typescript)
[![Coverage Status](https://coveralls.io/repos/github/securedeveloper/react-data-export-typescript/badge.svg?branch=master)](https://coveralls.io/github/securedeveloper/react-data-export-typescript?branch=master)

A data export library built with and for [React](http://facebook.github.io/react/index.html).

## Installation

With [npm](https://www.npmjs.org/package/react-data-export-typescript):

```sh
npm install react-data-export-typescript --save
```
